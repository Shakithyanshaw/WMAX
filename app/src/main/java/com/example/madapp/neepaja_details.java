...
public class neepaja_details extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.neepaja_detail);
        ...
        closeImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(neepaja_details.this, supplier.class));
            }
        });
        ...
        notiImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Perform action when image is clicked
                startActivity(new Intent(neepaja_details.this, notification.class));
            }
        });
